...
const BOOKS = [
  { title: "Bahr-e-Zikhar (Zikar Silsilah-e Madariyah)", file: "Bahr-e-Zikhar-farsi.pdf" },
  { title: "Saife Qaate",                                 file: "Saife-qaate-farsi.pdf" },
  { title: "Tazkiratul Muttaqeen",                        file: "Tazkiratul-muttaqeen-farsi.pdf" },
];
  ...
  return (
    ...
    >
      ...
      >
        ...
        {numPages > 0 && (
          <div className="flex items-center justify-center gap-4 px-5 py-2.5 shrink-0 text-sm font-medium"
               style={{ background: C.dark, color: C.onDark }}>
...
function BookCard({ title, file, idx, C }: { title: string; file: string; idx: number; C: CType }) {
  ...
  const pdfPath = `https://github.com/Mazhar-54321/qutbul-madar/releases/download/Farsi-Books/${file}`;
  const proxyPath = `/api/pdf?file=${encodeURIComponent(file)}&tag=Farsi-Books`;
      ...
      >
        ...
        <div className="flex flex-col flex-1 p-6 gap-4">
          <div className="flex items-start justify-between gap-3">
            <div className="w-11 h-11 rounded-xl flex items-center justify-center shrink-0 transition-colors duration-300 group-hover:bg-[#2d7a4f]"
            ...
            <span className="text-[10px] font-bold tabular-nums px-2 py-1 rounded-full shrink-0"
          ...
          <div className="flex-1">
            ...
            <p className="text-[11px] mt-1.5 font-medium" style={{ color: C.muted }}>Farsi · PDF</p>
          </div>
...
export default function FarsiBooksPage() {
  const C = useC();
  ...
  return (
    <main className="min-h-screen" style={{ background: C.cream, color: C.text }} dir={isRtl ? "rtl" : "ltr"}>
        ...
        <div className="relative max-w-7xl mx-auto px-6 lg:px-16 pt-10 pb-16">
          ...
          <motion.div variants={stagger} initial="hidden" animate="show" className="max-w-3xl">
            ...
            <motion.p variants={fadeUp} className="text-[15px] leading-relaxed mb-10 max-w-xl"
              ...
              Persian-language books on Hazrat Qutbul Madar and the Madariya Silsilah — available to read online or download free.
            </motion.p>
      ...
      {/* SEARCH */}
      <section className="py-8 sticky top-14 z-30"
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-16">
          <div className="grid lg:grid-cols-[1fr_auto] gap-10 items-center">
            ...
            <motion.div initial={{ opacity: 0, y: 16 }} whileInView={{ opacity: 1, y: 0 }}
                        ...
                        className="flex flex-col gap-3 min-w-45">
