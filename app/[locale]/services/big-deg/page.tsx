...
function PillarCard({ heading, body, isRtl, index, C }: {
  ...
  return (
    <motion.div
      ...
      className="group rounded-r-2xl p-6 transition-all duration-300 hover:-translate-y-0.5"
      style={{
        background: C.white,
      ...
      <section style={{ background: C.dark }} className="relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-6 lg:px-16 pt-10 pb-0">
          ...
          <motion.div variants={stagger} initial="hidden" animate="show" className="max-w-3xl pb-8">
            <motion.div variants={fadeUp}><Tag>Noble Tradition</Tag></motion.div>
      ...
      <section className="py-16 lg:py-20" style={{ background: C.cream }}>
        <div className="max-w-4xl mx-auto px-6 lg:px-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-x-10 gap-y-5 mb-12">
            {[t("ingredients_body"), t("cooking_body"), t("distribution_body"), t("volunteer_body")].map((para, i) => (
          ...
          <motion.div initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }}
            ...
            <span className="w-5 h-px" style={{ background: C.gold }} />
            <span className="text-[10px] font-bold tracking-[0.18em] uppercase" style={{ color: C.gold }}>Key pillars</span>
            <div className="flex-1 h-px" style={{ background: C.cream3 }} />
          </motion.div>
          ...
          <motion.div initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }}
                      className="flex items-center gap-3 mb-6">
            <span className="w-5 h-px" style={{ background: C.gold }} />
            <span className="text-[10px] font-bold tracking-[0.18em] uppercase" style={{ color: C.gold }}>Gallery</span>
            <div className="flex-1 h-px" style={{ background: C.cream3 }} />
          </motion.div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-12">
            {[
        ...
        <div className="relative max-w-7xl mx-auto px-6 lg:px-16">
          <div className="grid lg:grid-cols-[1fr_auto] gap-10 items-center">
            <motion.div variants={stagger} initial="hidden" whileInView="show" viewport={{ once: true }}>
              <motion.div variants={fadeUp}><Tag light>Sponsor a Deg</Tag></motion.div>
