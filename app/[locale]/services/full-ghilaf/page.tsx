      ...
      <section style={{ background: C.dark }} className="relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-6 lg:px-16 pt-10 pb-0">
          ...
          <motion.div variants={stagger} initial="hidden" animate="show" className="max-w-3xl pb-8">
            <motion.div variants={fadeUp}><Tag>Dargah service</Tag></motion.div>
          ...
          <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }}
            ...
            <Image src="/images/image2.webp" alt="Full Ghilaaf — Qutbul Madar Dargah"
      ...
      <section className="py-16 lg:py-20" style={{ background: C.cream }}>
        <div className="max-w-4xl mx-auto px-6 lg:px-16">
          ...
          <motion.div initial={{ opacity: 0, y: 16 }} whileInView={{ opacity: 1, y: 0 }}
                      ...
                      className="relative overflow-hidden mb-8 rounded-r-2xl p-7"
                      style={{
                        background: C.cream2,
          ...
          <motion.div initial={{ opacity: 0, scale: 0.98 }} whileInView={{ opacity: 1, scale: 1 }}
            ...
            <div className="absolute bottom-4 start-5">
              <span className="text-xs font-medium" style={{ color: C.onDark }}>Full Ghilaaf ceremony — Dargah Qutbul Madar</span>
            </div>
          </motion.div>
          ...
          <div className="h-px mb-10"
               style={{ background: `linear-gradient(to right, ${C.gold}, transparent)`, opacity: 0.2 }} />
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }}
                      ...
                      style={{
                        ...
                        boxShadow: "0 16px 48px rgba(28,18,8,0.2)",
                      }}>
        ...
        <div className="relative max-w-7xl mx-auto px-6 lg:px-16">
          <div className="grid lg:grid-cols-[1fr_auto] gap-10 items-center">
            <motion.div variants={stagger} initial="hidden" whileInView="show" viewport={{ once: true }}>
              <motion.div variants={fadeUp}><Tag>Participate in this sacred tradition</Tag></motion.div>
              ...
              <motion.p variants={fadeUp} className="text-[15px] leading-relaxed max-w-lg"
                ...
                Join devotees in honouring the sacred tomb of Hazrat Qutbul Madar
                by offering a Full Ghilaaf at Makanpur Shareef.
              </motion.p>
            </motion.div>
            <motion.div initial={{ opacity: 0, y: 16 }} whileInView={{ opacity: 1, y: 0 }}
