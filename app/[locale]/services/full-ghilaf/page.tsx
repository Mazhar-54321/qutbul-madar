    ...
    >
        ...
        <div className="relative max-w-7xl mx-auto px-6 lg:px-16 pt-10 pb-0">
          ...
          >
            <Image
              ...
              alt="Full Ghilaaf — Qutbul Madar Dargah"
              fill
              priority
      ...
      <section className="py-16 lg:py-20" style={{ background: C.cream }}>
        <div className="max-w-4xl mx-auto px-6 lg:px-16">
          ...
          {/* Lead paragraph — highlighted blockquote */}
          <motion.div
            initial={{ opacity: 0, y: 16 }}
          ...
          {/* Second image — mid content (mirrors existing site) */}
          <motion.div
          ...
          >
            <Image
              src="/images/full-ghilaf.webp"
              alt="Full Ghilaaf ceremony"
              fill
              className="object-cover object-center"
              sizes="100vw"
            />
            <div
              className="absolute inset-0"
              style={{
                background: `linear-gradient(to top, ${C.dark}55, transparent)`,
              }}
            />
            <div className="absolute bottom-4 start-5">
              <span className="text-xs font-medium" style={{ color: C.cream }}>
                Full Ghilaaf ceremony — Dargah Qutbul Madar
              </span>
            </div>
          </motion.div>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-16">
          <div className="grid lg:grid-cols-[1fr_auto] gap-10 items-center">
            ...
            >
              ...
              >
                Join devotees in honouring the sacred tomb of Hazrat Qutbul
                Madar by offering a Full Ghilaaf at Makanpur Shareef.
              </motion.p>
            </motion.div>
