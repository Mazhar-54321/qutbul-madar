...
export default function LiveZiyaratPage() {
  ...
  const content = [
    t("intro"), t("belief_body"), t("process_body"),
    t("preparation_body"), t("purpose_body"), t("impact_body"), t("volunteer_body"),
  ].join("\n\n");
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-16">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }}
            ...
            <div className="text-8xl leading-none absolute top-2 end-6 font-serif select-none"
                 style={{ color: "rgba(200,149,108,0.06)" }}>&quot;</div>
            <Tag light>About this service</Tag>
      ...
      <section className="pb-16" style={{ background: C.cream }}>
        <div className="max-w-7xl mx-auto px-6 lg:px-16">
          <div className="grid lg:grid-cols-2 gap-12 items-start">
            ...
            {/* Right column — with inline image */}
            <div className="flex flex-col gap-6">
              <motion.div initial={{ opacity: 0, scale: 0.97 }} whileInView={{ opacity: 1, scale: 1 }}
                          viewport={{ once: true }} transition={{ duration: 0.6 }}
                          className="relative rounded-2xl overflow-hidden mb-2"
                          style={{ aspectRatio: "4/3", border: "1px solid rgba(200,149,108,0.12)" }}>
                <Image src="/images/image8.webp" alt="Ziyarat at Dargah"
                       fill className="object-cover" sizes="(max-width: 1024px) 100vw, 50vw" />
                <div className="absolute inset-0"
                     style={{ background: `linear-gradient(to top, ${C.dark}66, transparent)` }} />
                <div className="absolute bottom-3 start-4">
                  <span className="text-xs font-medium" style={{ color: C.gold }}>Ziyarat at Dargah Shareef</span>
                </div>
              </motion.div>
              {colRight.map((para, i) => (
                <motion.p key={i} initial={{ opacity: 0, y: 14 }} whileInView={{ opacity: 1, y: 0 }}
        ...
        <div className="relative max-w-7xl mx-auto px-6 lg:px-16">
          <div className="grid lg:grid-cols-[1fr_auto] gap-10 items-center">
            <motion.div variants={stagger} initial="hidden" whileInView="show" viewport={{ once: true }}>
              <motion.div variants={fadeUp}><Tag light>Join a Live Ziyarat session</Tag></motion.div>
              ...
              <motion.p variants={fadeUp} className="text-[15px] leading-relaxed max-w-lg"
                ...
                Experience the spiritual atmosphere of the sacred Dargah remotely.
                Contact us to arrange your Live Ziyarat and Dua session.
              </motion.p>
            </motion.div>
